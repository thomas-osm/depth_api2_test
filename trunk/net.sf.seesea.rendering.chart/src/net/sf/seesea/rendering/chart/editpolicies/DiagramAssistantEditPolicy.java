...
//		if (getHost() instanceof Transactional) {
...
//				}
	...
	public void activate() {
		super.activate();
		((GraphicalEditPart) getHost()).getFigure().addMouseMotionListener(
			this);
	...
	public void deactivate() {
		((GraphicalEditPart) getHost()).getFigure().removeMouseMotionListener(
			this);
