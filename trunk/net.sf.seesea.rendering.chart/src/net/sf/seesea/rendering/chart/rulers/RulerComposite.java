...
import net.sf.seesea.rendering.chart.editpart.RulerRootEditPart;
...
public class RulerComposite extends Composite {
	...
	private final RulerModel verticalRulermodel;
	private final RulerModel horizontalRulermodel;
	...
	public RulerComposite(Composite parent, int style) {
		...
		verticalRulermodel = new RulerModel(false);
		horizontalRulermodel = new RulerModel(true);
	}
...
//				.getProperty(RulerProvider.PROPERTY_RULER_VISIBILITY);
		...
		setRuler(horizontalRulermodel, PositionConstants.NORTH);
		setRuler(verticalRulermodel, PositionConstants.WEST);
	}

	private void setRuler(RulerModel model, int orientation) {
		Object ruler = null;
//		if (isRulerVisible && model != null)
...
//				}
	...
	public void setWorld(World world) {
		verticalRulermodel.setWorld(world);
		horizontalRulermodel.setWorld(world);
	}
