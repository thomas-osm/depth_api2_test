...
InstallDir "$PROGRAMFILES32\${COMPANYNAME}\${APPNAME}"
...
#Icon "logo.ico"
outFile "DataLoggerInstaller_${VERSION}_win_x86.exe"
...
#    file "NMEALogger.exe"
    file /r "/var/lib/hudson/jobs/DataLoggerSingleSF/lastSuccessful/archive/buckminster.output/net.sf.seesea.nmea.datalogger.site_1.0.0-eclipse.feature/nmeaDataLoggger.win32.win32.x86/*.*"
