 ...
 * @generated
 */
public class LightsSwitch<T> extends Switch<T> {
	/**
	 ...
	 * @generated
	 */
	protected static LightsPackage modelPackage;
	...
	public LightsSwitch() {
		if (modelPackage == null) {
			modelPackage = LightsPackage.eINSTANCE;
		}
	}
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case LightsPackage.LIGHT_CHARACTER: {
				LightCharacter lightCharacter = (LightCharacter)theEObject;
				T result = caseLightCharacter(lightCharacter);
