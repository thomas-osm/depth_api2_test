...
public final class FormAttachment {
	 ...
	 */
	public FormAttachment (IFigure control) {
	 ...
	 */
	public FormAttachment (IFigure control, int offset) {
	 ...
	 */
	public FormAttachment (IFigure control, int offset, int alignment) {
