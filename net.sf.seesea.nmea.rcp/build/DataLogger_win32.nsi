...
#    file "NMEALogger.exe"
    file /r "/var/lib/hudson/jobs/DataLoggerSingle/lastSuccessful/archive/buckminster.output/net.sf.seesea.nmea.datalogger.site_1.0.0-eclipse.feature/nmeaDataLoggger.win32.win32.x86/*.*"
