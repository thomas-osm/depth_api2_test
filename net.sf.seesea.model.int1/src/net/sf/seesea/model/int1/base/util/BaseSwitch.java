...
public class BaseSwitch<T> extends Switch<T> {
	...
	protected T doSwitch(int classifierID, EObject theEObject) {
		switch (classifierID) {
			case BasePackage.ABSTRACT_SEAMARK: {
				AbstractSeamark abstractSeamark = (AbstractSeamark)theEObject;
				T result = caseAbstractSeamark(abstractSeamark);
				if (result == null) result = caseGeoPosition(abstractSeamark);
				if (result == null) result = caseModelObject(abstractSeamark);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
			case BasePackage.MARINE_CHART: {
				MarineChart marineChart = (MarineChart)theEObject;
				T result = caseMarineChart(marineChart);
				if (result == null) result = caseWorld(marineChart);
				if (result == null) result = caseNamedArtifact(marineChart);
				if (result == null) result = caseArea(marineChart);
				if (result == null) result = caseChart(marineChart);
				if (result == null) result = caseNavigationCompound(marineChart);
				if (result == null) result = caseModelObject(marineChart);
				if (result == null) result = defaultCase(theEObject);
				return result;
			}
	...
	/**
	 * Returns the result of interpreting the object as an instance of '<em>Marine Chart</em>'.
	 * <!-- begin-user-doc -->
	 * This implementation returns null;
	 * returning a non-null result will terminate the switch.
	 * <!-- end-user-doc -->
	 * @param object the target of the switch.
	 * @return the result of interpreting the object as an instance of '<em>Marine Chart</em>'.
	 * @see #doSwitch(org.eclipse.emf.ecore.EObject) doSwitch(EObject)
	 * @generated
	 */
	public T caseMarineChart(MarineChart object) {
		return null;
	}
