...
public class BaseFactoryImpl extends EFactoryImpl implements BaseFactory {
	...
	public static BaseFactory init() {
		try {
			BaseFactory theBaseFactory = (BaseFactory)EPackage.Registry.INSTANCE.getEFactory("base"); 
	...
	public EObject create(EClass eClass) {
		switch (eClass.getClassifierID()) {
			case BasePackage.MARINE_CHART: return createMarineChart();
			default:
	 ...
	 * @generated
	 */
	public MarineChart createMarineChart() {
		MarineChartImpl marineChart = new MarineChartImpl();
		return marineChart;
	}
